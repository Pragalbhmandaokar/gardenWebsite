  ...
  return (
    <div className="w-full bg-[#042511fb]">
      <div className="w-full px-10 py-4">
        <div
          className="w-full h-[95vh]  flex flex-col justify-center items-center   shadow-black shadow-xl rounded-3xl border-[1px] border-green-900"
          style={{
        ...
        >
          <div className="w-full h-[100%] bg-[#00000066] rounded-3xl ">
            <div className="text-[#ffffffdc] w-full flex justify-center items-center pt-20 text-[40px] tracking-widest font-extrabold ">
              MYRITIE'S GARDEN
            </div>
